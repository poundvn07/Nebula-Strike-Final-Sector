...
SPACE_ROOSTER_WIDTH = 96
SPACE_ROOSTER_HEIGHT = 96
SPACE_ROOSTER_HP = 350
SPACE_ROOSTER_BASE_SPEED = 30.0
...
SPACE_ROOSTER_PHASE_TWO_SPEED_MULTIPLIER = 1.3
SPACE_ROOSTER_PHASE_THREE_SPEED_MULTIPLIER = 1.6
SPACE_ROOSTER_PHASE_ONE_ATTACK_INTERVAL_SECONDS = 2.0
SPACE_ROOSTER_PHASE_TWO_ATTACK_INTERVAL_SECONDS = 2.0
SPACE_ROOSTER_PHASE_THREE_ATTACK_INTERVAL_SECONDS = 1.0
...
SPACE_ROOSTER_PROJECTILE_SPEED = 150.0
SPACE_ROOSTER_DIAGONAL_SPEED = 85.0
SPACE_ROOSTER_BEAM_SPEED = 220.0
SPACE_ROOSTER_RAPID_SPEED = 180.0
...
class SpaceRooster(Enemy):
    ...
    def on_death(self) -> list[FeatherCore]:
        """Override on_death() to trigger the boss explosion flag and drop 30-50 FC."""
        self.boss_death_explosion_triggered = True
        drop_count = randint(SPACE_ROOSTER_FC_DROP_MIN, SPACE_ROOSTER_FC_DROP_MAX)
