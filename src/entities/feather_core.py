...
FEATHER_CORE_WIDTH = 20
FEATHER_CORE_HEIGHT = 20
FEATHER_CORE_COLLISION_SIZE = 20
...
FEATHER_CORE_BASE_RADIUS = 8.0
FEATHER_CORE_RADIUS_AMPLITUDE = 2.0
FEATHER_CORE_MIN_RADIUS = 6
